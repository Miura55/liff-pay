...
price = 1500																			# 登録値(SmileCount)


def PostToKintone(url, appId, apiToken, userID, price):
	record={'user_id':{'value' : userID}, 'price':{'value' : price}}			# フィールドコードと書込むデータを指定
...
if __name__ == '__main__':
	resp= PostToKintone(URL, APP_ID, API_TOKEN)
	print(resp.text)
